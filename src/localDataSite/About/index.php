...
<ul id="ulist">
    ...
    <div id="container" class="clear">
        ...
        <div id="about-intro" class="clear">
            ...
            <div class="one_half"><img src="<?php echo $range ?>images/logo.png" alt="Template Demo Image" /></div>
        </div>
        ...
        <div id="team">
            ...
            <li class="one_third first">
                <div class="figure"><img src="<?php echo $range?>images/lue_nathan.jpg" alt="Template Demo Image" />
                <div class="figcaption">
                    ...
                    <ul>
                        ...
                        <li><a href=""><img src="<?php echo $route ?>/About/images/pornhub.ico" alt="Pornhub icon" /></a></li>
                    </ul>
            ...
            <li class="one_third">
                <div class="figure"><img src="<?php echo $range?>images/da_silva_andre_thomas.jpg" alt="Template Demo Image" />
                <div class="figcaption">
                    <div class="fl_left">
            ...
            <li class="one_third">
                <div class="figure"><img src="<?php echo $range?>images/aloise_alessandro.jpg" alt="Template Demo Image" />
                <div class="figcaption">
                    <div class="fl_left">
